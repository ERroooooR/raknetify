 ...
 *         channel.pipeline().addLast("writeTimeoutHandler", new {@link DebugWriteTimeoutHandler}(30);
 ...
 */
public class DebugWriteTimeoutHandler extends ChannelOutboundHandlerAdapter {
     ...
     */
    public DebugWriteTimeoutHandler(int timeoutSeconds) {
     ...
     */
    public DebugWriteTimeoutHandler(long timeout, TimeUnit unit) {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        if (timeoutNanos > 0) {
            ...
            scheduleTimeout(ctx, msg, promise);
        }
    ...
    private void scheduleTimeout(final ChannelHandlerContext ctx, Object msg, final ChannelPromise promise) {
        // Schedule a timeout.
        final WriteTimeoutTask task = new WriteTimeoutTask(ctx, msg, promise);
    ...
    private final class WriteTimeoutTask implements Runnable, ChannelFutureListener {
        ...
        WriteTimeoutTask(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
            this.ctx = ctx;
            this.msg = msg;
